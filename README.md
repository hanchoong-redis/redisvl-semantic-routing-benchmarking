...
| Topic     | DBLP         | 46.8                 | 79.7(0.7)                  | 62.6(0.9) | 81.4(0.5)                        | 81.4(0.6) | 87.8(0.4) | 86.7(0.5)                        | 86.5(0.5) |   |   |   |
...
|           | Reuters90    | 27.2                 | 33.2(2.3)                  | 27.0(1.6) | 41.9(2.2)                        | 41.3(2.6) | 41.5(2.6) | 41.5(2.4)                        | 41.7(2.7) |   |   |   |
...
|           | yelp_reviews | 97.2                 | 94.8(0.7)                  | 87.9(0.9) | 97.9(0.4)                        | 97.3(0.4) | 99.4(0.1) | 99.1(0.3)                        | 99.1(0.2) |   |   |   |
...
### Concise Table
| Category  | Dataset      | Redis (OOTB) | Trad (LSVM–RF) | SLM (RoBERTa–XLNet) | LLM (Mistral–DeepSeek) | Dataset Size | # Classes | Skewness              |
| ---------- | ------------- | ------------- | ---------------- | -------------------- | ----------------------- | ------------- | ---------- | ---------------------- |
